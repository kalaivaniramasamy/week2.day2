	...
	public class DeleteLead {
		...
		public static void main(String[] args) throws InterruptedException {
					...
					if(displayMsg != null && displayMsg.equalsIgnoreCase("No records to display"))
						...
						System.out.println("The given Lead ID " +leadID+ "The Lead deleted successfully");
					
					else
						
						System.out.println("The given Lead ID " +leadID+ " The Lead not deleted successfully");
