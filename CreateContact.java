package week2.day2;
	...
	public class CreateContact {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			chromeDriver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("kalai");
			
			//Enter LastName(Local)
			chromeDriver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("VL");
			
			//Enter Department Name
			chromeDriver.findElement(By.name("departmentName")).sendKeys("CT");
			
			//Enter description
			chromeDriver.findElement(By.name("description")).sendKeys("Computer Technology");
			...
			stateProvinceSelect.selectByVisibleText("india");
