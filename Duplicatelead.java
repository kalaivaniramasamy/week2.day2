	...
	public class Duplicatelead {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			// Setup the driver
					...
					// Enter Email Address
					chromeDriver.findElement(By.xpath("(//label[text()='Email Address:']/following::input)[1]")).sendKeys("kalaivaniramasamyr@gmai.com");
					...
					if(firstName != null && lastName != null) 
					{
						if(firstName.equalsIgnoreCase(firstNameActual) && lastName.equalsIgnoreCase(lastNameActual))
							System.out.println("The Both actual and duplicated leads are same based");
						else
